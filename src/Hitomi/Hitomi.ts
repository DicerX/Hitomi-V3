...
const SOURCE_DOMAIN = "https://hitomi.la"

export class Hitomi extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'Hitomi' }
    get description(): string { return 'Hentai' }
    get author(): string { return 'Darknight' }
